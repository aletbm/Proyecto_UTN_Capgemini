...
class GameUsuario(models.Model):
    ...
    countries_idcountries = models.IntegerField(db_column='Countries_idCountries')  # Field name made lowercase.
    puntuacionmax_idpuntuacion = models.IntegerField(db_column='PuntuacionMAx_idPuntuacion')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'game_usuario'
...
class Pregunta(models.Model):
    ...
    opcion1 = models.CharField(max_length=45, blank=True, null=True)
    opcion2 = models.CharField(max_length=45, blank=True, null=True)
    opcion3 = models.CharField(max_length=45, blank=True, null=True)
    opcion4 = models.CharField(max_length=45, blank=True, null=True)
    opcion5 = models.CharField(max_length=45, blank=True, null=True)
